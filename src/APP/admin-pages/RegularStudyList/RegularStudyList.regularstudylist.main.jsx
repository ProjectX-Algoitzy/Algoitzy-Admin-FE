        ...
        <itemS.Container>
            <itemS.InnerContainer>
                <itemS.TitleContainer>
                    <itemS.ApplicationText>정규 스터디</itemS.ApplicationText>
                    <itemS.BtnMakeApp onClick={handleWriteClick}>+ 스터디 생성하기</itemS.BtnMakeApp>
                </itemS.TitleContainer>
                <itemS.Group>
                    {studyList.map((item) => (
                        <RegularStudyListIndividual key={item.studyId} application={item} />
                    ))}
                </itemS.Group>
            </itemS.InnerContainer>
        </itemS.Container>
