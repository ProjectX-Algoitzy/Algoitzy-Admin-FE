    ...
    return (
        <itemS.Container>
            <itemS.InnerContainer>
                    ...
                    <>
                        ...
                        <itemS.TitleContainer>
                            ...
                            <img
                                ...
                                alt="정규스터디 아이콘"
                                style={{marginLeft: '0.333rem', width: '1.833rem', height: '0.875rem'}}
                            />
                        </itemS.TitleContainer>
                        <itemS.CountAndOnlineContainer>
                            <itemS.CountContainer>
                                <img
                                    ...
                                    alt="사람아이콘"
                                    style={{width: '1rem', height: '1rem', marginRight: '0.333rem'}}
                                />
                ...
                <itemS.LinkContainer>
                    <itemS.styledLink onClick={() => setActiveComponent('home')} isActive={activeComponent === 'home'}>
