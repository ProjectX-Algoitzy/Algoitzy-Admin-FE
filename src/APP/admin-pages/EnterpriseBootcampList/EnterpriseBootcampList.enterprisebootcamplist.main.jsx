...
export default function EnterBootList() {
  ...
  const fetchInstitutionList = async () => {
    ...
    try {
      const response = await request.get(
        `/institution?searchKeyword=${searchKeyword}&type=${type}&sort=${sortType}&page=${
          currentPage + 1
        }&size=${itemsPerPage}`
      );
  ...
  }, [selectedTab, type, sortType, currentPage, debouncedQuery]);
            ...
            <itemS.CategoryInterviewContainer>
              ...
              {isSortDropVisible && (
                <itemS.SortDrop>
                  ...
                  <itemS.SortText onClick={() => onSortType("NAME")}>
                    이름순
                  </itemS.SortText>
                </itemS.SortDrop>
              )}
