          ...
          <itemS.CommentBox>
            <itemS.WriterBox>
              ...
              <itemS.DotBox ref={modalRef} onClick={handleDotClick}>
                ...
                {isUtilBoxVisible && ( // isUtilBoxVisible 상태에 따라 표시
                  <itemS.UtilButtonBox onClick={handleDelete}>
            ...
            {item.deleteYn ? (
              <itemS.ContentBox>
                  ...
                  <itemS.Content deleteYn={item.deleteYn}>{item.deleteByAdminYn ? '관리자에 의해 삭제된 댓글 입니다.' : '작성자에 의해 삭제된 댓글 입니다.'}</itemS.Content>
                </itemS.ContentBox>
              ) : (
                <itemS.ContentBox>
                  <itemS.Content deleteYn={item.deleteYn}>{item.content}</itemS.Content>
                </itemS.ContentBox>
              )}
            <itemS.InfoBottomBox>
